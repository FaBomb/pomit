...
$(function () {
  var chatChannel = _consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create({
    channel: 'RoomChannel',
  ...
  $(".post_btn").on('keypress', '[data-behavior~=room_speaker]', function (event) {
    chatChannel.speak(event.target.value);
    event.target.value = '';
    return event.preventDefault();
  });
...
/******/ });
//# sourceMappingURL=application-fc8aa4a671ada8fa303a.js.map